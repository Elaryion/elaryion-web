...
export default function ChatBubble() {
  ...
  return (
    <div className="fixed bottom-4 right-0 left-0 sm:right-4 sm:left-auto z-50 flex justify-end">
      <AnimatePresence>
        {!isOpen ? (
          <motion.button 
            initial={{ scale: 0 }}
            ...
            className="bg-indigo-600 text-white p-4 rounded-full shadow-lg hover:bg-indigo-700 transition-colors mr-4"
          >
          ...
          <div className="w-full flex justify-center sm:justify-end">
            <motion.div 
              ...
              className="bg-white rounded-lg shadow-xl w-[calc(100vw-2rem)] sm:w-[380px] max-w-[380px] h-[500px] flex flex-col"
            >
              {/* Header */}
